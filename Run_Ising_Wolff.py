...
if ferro == 1:
    Temp,E,M,Cp,Chi = np.load(filepath + 'Temp_Ferro_Wolff_100.npy'), np.load(filepath + 'Energy_Ferro_Wolff_100.npy'), np.load(filepath + 'Magnetization_Ferro_Wolff_100.npy'), np.load(filepath + 'Specific_Heat_Ferro_Wolff_100.npy'), np.load(filepath + 'Susceptibility_Ferro_Wolff_100.npy')
...
ax1.plot(Temp[1:],E[1:], marker = 'o', ls = 'None', color = 'k')
ax2.plot(Temp[1:],M[1:], marker = 'o', ls = 'None', color = 'b')
ax3.plot(Temp[1:],Cp[1:], marker = 'o', ls = 'None', color = 'orange')
ax4.plot(Temp[1:],Chi[1:], marker = 'o', ls = 'None', color = 'cyan')
...
fig1.suptitle('Ferromagnetic Ising Model',fontsize = 20)
...
if average == 1:
    ...
    Chi1,Chi2,Chi3,Chi4 =  np.load(filepath + 'Susceptibility_Ferro_Wolff_run1.npy'), np.load(filepath + 'Susceptibility_Ferro_Wolff_run2.npy'), np.load(filepath + 'Susceptibility_Ferro_Wolff_run3.npy'), np.load(filepath + 'Susceptibility_Ferro_Wolff_run4.npy'),
    Cp1,Cp2,Cp3,Cp4 = np.load(filepath + 'Specific_Heat_Ferro_Wolff_run1.npy'),np.load(filepath + 'Specific_Heat_Ferro_Wolff_run2.npy'),np.load(filepath + 'Specific_Heat_Ferro_Wolff_run3.npy'),np.load(filepath + 'Specific_Heat_Ferro_Wolff_run4.npy'),
