...
if gen == 1:
    ...
    if ferro == 1:
        #Save Data
        np.save(filepath + 'Temp_Ferro.npy', Temp)
        np.save(filepath + 'Energy_Ferro.npy', E)
        np.save(filepath + 'Magnetization_Ferro.npy', M)
        np.save(filepath + 'Specific_Heat_Ferro.npy', Cp)
        np.save(filepath + 'Susceptibility_Ferro.npy', Chi)
#Load Data
if anti == 1:
...
if ferro == 1:
    Temp,E,M,Cp,Chi = np.load(filepath + 'Temp_Ferro.npy'), np.load(filepath + 'Energy_Ferro.npy'), np.load(filepath + 'Magnetization_Ferro.npy'), np.load(filepath + 'Specific_Heat_Ferro.npy'), np.load(filepath + 'Susceptibility_Ferro.npy')
...
fig1.suptitle('AntiFerromagnetic Triangular Ising Model',fontsize = 20)
